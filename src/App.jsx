  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/nursesummit-orators"element={<Orators />} />
        <Route path= "/about-nursesummit"element={<AboutOralMed />} />
        <Route path="/nursesummit-event-schedule" element={<EventSchedule />} />
        <Route path="/venue" element={<Venue/>}/>
        <Route path="/contact" element={<ContactForm />} />
        <Route path="/nursesummit-conference-tracks/" element={<RotatingLogos />} />
